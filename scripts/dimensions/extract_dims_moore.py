#!/usr/bin/env python3
"""
Extract piece dimensions (L/W/H) from mooreoffice.com product pages.
Uses data/extracted/moore.csv or data/ready/extracted.
...
def main():
    ap = argparse.ArgumentParser(description="Extract dimensions from mooreoffice.com product pages")
