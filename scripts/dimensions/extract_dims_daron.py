#!/usr/bin/env python3
"""
Extract piece dimensions (L/W/H) from modeltoycars.com product pages.
Uses data/extracted/daron.csv or data/ready/extracted.
...
def main():
    ap = argparse.ArgumentParser(description="Extract dimensions from modeltoycars.com product pages")
