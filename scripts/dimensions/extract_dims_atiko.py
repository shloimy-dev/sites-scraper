#!/usr/bin/env python3
"""
Extract dimensions for mostlymusic.com (Atiko) products.
Load data/extracted/atiko.csv, fetch product_url, extract dimensions from JSON-LD or HTML.
"""
import argparse
import sys
import time
...
def main():
    ap = argparse.ArgumentParser(description="Extract dimensions from mostlymusic.com (Atiko) product pages")
    ...
    if not rows or not path:
        print("No atiko.csv found in data/extracted or data/ready/extracted")
        sys.exit(1)
