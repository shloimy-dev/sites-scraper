#!/usr/bin/env python3
"""
Extract piece dimensions (L/W/H) from sands.com product pages.
Uses data/extracted/sands.csv or data/ready/extracted.
...
def main():
    ap = argparse.ArgumentParser(description="Extract dimensions from sands.com product pages")
