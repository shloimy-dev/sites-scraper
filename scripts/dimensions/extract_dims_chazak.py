#!/usr/bin/env python3
"""
Extract piece dimensions (L/W/H) from chazakkinder.com product pages.
Uses data/extracted/chazak.csv or data/ready/extracted.
...
def main():
    ap = argparse.ArgumentParser(description="Extract dimensions from chazakkinder.com product pages")
