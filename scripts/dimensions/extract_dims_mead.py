#!/usr/bin/env python3
"""
Extract piece dimensions (L/W/H) from mead.com product pages.
Uses data/extracted/mead.csv or data/ready/extracted.
...
def main():
    ap = argparse.ArgumentParser(description="Extract dimensions from mead.com product pages")
