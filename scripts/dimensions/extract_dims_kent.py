#!/usr/bin/env python3
"""
Extract piece dimensions (L/W/H) from kent.bike product pages.
Uses data/extracted/kent.csv or data/ready/extracted.
...
def main():
    ap = argparse.ArgumentParser(description="Extract dimensions from kent.bike product pages")
