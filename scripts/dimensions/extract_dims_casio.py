#!/usr/bin/env python3
"""
Extract piece dimensions (L/W/H) from casio.com product pages.
Uses data/extracted/casio.csv or data/ready/extracted.
...
def main():
    ap = argparse.ArgumentParser(description="Extract dimensions from casio.com product pages")
