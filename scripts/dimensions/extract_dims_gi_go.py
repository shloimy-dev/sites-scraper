#!/usr/bin/env python3
"""
Extract piece dimensions (L/W/H) from gigotoys.com.hk product pages.
Uses data/extracted/gi_go.csv or data/ready/extracted.
...
def main():
    ap = argparse.ArgumentParser(description="Extract dimensions from gigotoys.com.hk product pages")
