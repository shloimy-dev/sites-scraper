#!/usr/bin/env python3
"""
Extract piece dimensions (L/W/H) from winning-moves.com product pages.
Uses data/extracted/winning_moves.csv or data/ready/extracted.
...
def main():
    ap = argparse.ArgumentParser(description="Extract dimensions from winning-moves.com product pages")
    ...
    if not rows or not path:
        print("No CSV found for winning_moves")
        return 1
