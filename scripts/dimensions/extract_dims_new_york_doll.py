#!/usr/bin/env python3
"""
Extract dimensions for thenewyorkdollcollection.com products.
Load data/extracted/new_york_doll.csv, fetch product_url, extract dimensions from JSON-LD or HTML.
"""
import argparse
import sys
import time
...
def main():
    ap = argparse.ArgumentParser(description="Extract dimensions from thenewyorkdollcollection.com product pages")
    ...
    if not rows or not path:
        print("No new_york_doll.csv found in data/extracted or data/ready/extracted")
        sys.exit(1)
