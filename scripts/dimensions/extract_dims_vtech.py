#!/usr/bin/env python3
"""
Extract piece dimensions (L/W/H) from vtechkids.com product pages.
Uses data/extracted/vtech.csv or data/ready/extracted.
...
def main():
    ap = argparse.ArgumentParser(description="Extract dimensions from vtechkids.com product pages")
