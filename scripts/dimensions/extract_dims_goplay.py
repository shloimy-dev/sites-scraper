#!/usr/bin/env python3
"""
Extract piece dimensions (L/W/H) from goplay.shopping product pages.
Uses data/extracted/goplay.csv or data/ready/extracted.
...
def main():
    ap = argparse.ArgumentParser(description="Extract dimensions from goplay.shopping product pages")
