#!/usr/bin/env python3
"""
GoPlay scraper. Sheet-only: goplay.shopping may be password-locked.
Brands: "need to download images from google" - use sheet data.
"""
import sys
...
def main():
    ...
    print(f"Done: {len(results)} products (sheet-only)")
