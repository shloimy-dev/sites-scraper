...
## Data and Images Progress

*Last updated: Mar 6, 2025. Run `python3 scripts/audit_stores.py` to regenerate.*

| Metric | Count |
|--------|-------|
| **Stores in audit** | 57 |
| **Stores with FULL data** | 1 (kent) |
| **Images downloaded** | ~4,000 files in `data/images/<site_id>/` |

Status: **FULL** = images, descriptions, and dimensions complete; **GAP** = missing one or more.
...
|-------|-------|----------|--------|--------------|------------|--------|
| akito | 0 | 27 | 27 | 12 | 0 | GAP |
| atiko | 28 | 28 | 0 | 19 | 0 | GAP |
| audster_biz | 0 | 31 | 5 | 5 | 1 | GAP |
...
| chazak_kinder | 0 | 176 | 176 | 124 | 3 | GAP |
...
| quercetti_biz | 0 | 34 | 23 | 23 | 0 | GAP |
...
| tiny_love_biz | 0 | 34 | 21 | 21 | 0 | GAP |
| vtech | 58 | 58 | 11 | 0 | 0 | GAP |
| winfun | 58 | 28 | 28 | 28 | 13 | GAP |
| winfun_biz | 0 | 58 | 70 | 26 | 0 | GAP |
| winning_moves | 60 | 7 | 3 | 7 | 0 | GAP |
| winning_moves_biz | 0 | 60 | 4 | 7 | 0 | GAP |

**Totals:** 57 stores in audit; 1 full (kent); ~4,000 images downloaded. Most stores need descriptions or dimensions.
